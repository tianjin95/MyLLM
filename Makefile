...
$(BUILD_DIR)/chat.o: chat.cpp chat.h runtime.h model.h llm.h | $(BUILD_DIR)
	$(CXX) $(CPPFLAGS) $(CXXFLAGS) -MMD -MP -c $< -o $@

$(BUILD_DIR)/llm.o: llm.cpp llm.h model.h | $(BUILD_DIR)
	$(CXX) $(CPPFLAGS) $(CXXFLAGS) -MMD -MP -c $< -o $@

$(BUILD_DIR)/model.o: model.cpp model.h llm.h | $(BUILD_DIR)
	$(CXX) $(CPPFLAGS) $(CXXFLAGS) -MMD -MP -c $< -o $@

$(BUILD_DIR)/runtime.o: runtime.cpp runtime.h model.h llm.h | $(BUILD_DIR)
	$(CXX) $(CPPFLAGS) $(CXXFLAGS) -MMD -MP -c $< -o $@

-include $(OBJECTS:.o=.d)

run: $(TARGET)
	./$(TARGET) --model "$(MODEL)" --tokens "$(TOKENS)" $(RAW_FLAG) $(SYSTEM_FLAG)
